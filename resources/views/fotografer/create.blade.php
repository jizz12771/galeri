...
<form action="{{ route('fotografer.store') }}" method="POST" class="bg-blur p-6 rounded-lg shadow">
    @csrf

    <label class="block mb-2 font-semibold">Nama Fotografer</label>
    <input type="text" name="nama_fotografer" class="w-full border text-cyan-300 rounded-lg p-2 mb-4">
